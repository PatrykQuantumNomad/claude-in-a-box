...
- [x] **SITE-02**: GitHub Actions deploy workflow deploys Astro site to GitHub Pages on push to main
- [x] **SITE-03**: Custom domain remotekube.patrykgolabek.dev configured with CNAME and working HTTPS
- [x] **SITE-04**: Existing CI workflow ignores site/ changes (paths-ignore filter)
- [x] **SITE-05**: Docker build context excludes site/ directory (.dockerignore updated)
